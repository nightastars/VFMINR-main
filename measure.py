...
def compute_measure1(x, y, pred, data_range):
...
def compute_SSIM(img1, img2, data_range, window_size=11, channel=1, size_average=True):
    ...
    if len(img1.size()) == 2:
        shape_1, shape_2 = img1.shape[0], img1.shape[1]
        img1 = img1.view(1, 1, shape_1, shape_2)
        img2 = img2.view(1, 1, shape_1, shape_2)
